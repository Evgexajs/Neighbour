import { SHOW_UPLOADER, HIDE_UPLOADER,CHANGE_UPLOAD_FILE, ADD_UPLOAD_FILE, REMOVE_UPLOAD_FILE } from "../actions/actionTypes";
...
export function upload (state = defaultState, action) {
    switch (action.type) {
